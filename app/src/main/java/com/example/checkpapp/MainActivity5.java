...
public class MainActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtTitulo = (EditText) findViewById(R.id.editTextTextPersonName7);
        edtFecha = (EditText) findViewById(R.id.editTextDate2);
        edtHoraIni = (EditText) findViewById(R.id.editTextTextPersonName8);
        edtHoraFin = (EditText) findViewById(R.id.editTextTextPersonName9);
        edtDesc = (EditText) findViewById(R.id.editTextTextMultiLine);
        edtAlarma = (EditText) findViewById(R.id.editTextTextPersonName10);
        btnAgendar = (Button) findViewById(R.id.button9);
