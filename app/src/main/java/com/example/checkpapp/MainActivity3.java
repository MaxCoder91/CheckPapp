...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtTitulo = (EditText) findViewById(R.id.editTextTextPersonName);
        edtFecha = (EditText) findViewById(R.id.editTextDate);
        edtHoraIni = (EditText) findViewById(R.id.editTextTextPersonName2);
        edtHoraFin = (EditText) findViewById(R.id.editTextTextPersonName3);
        edtDesc = (EditText) findViewById(R.id.editTextTextMultiLine2);
        edtAlarma = (EditText) findViewById(R.id.editTextTextPersonName4);
        btnAgendar = (Button) findViewById(R.id.button7);
